...
if( !class_exists( 'openSpacerApi' ) )
{
	class openSpacerApi
	{
		...
		{	
			...
			$url = "https://openspacer.org/api/v1/secured/".$api."/".$id.$param."?apiKey=".$apiKey;
			if($dataMethod == "fopen")
			{
	...
	add_shortcode('openspacer', array('openSpacerApi', 'openSpacerData') );
}